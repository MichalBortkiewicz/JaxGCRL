...
"""
Binpick-Hard: Move a cube from a random location in the blue bin to a random location in the red bin. Note that the bins only collide with the cube, not the hand/fingers.
