...
for seed in 1 2 3 4 5 ; do
  XLA_PYTHON_CLIENT_MEM_FRACTION=.95 MUJOCO_GL=egl CUDA_VISIBLE_DEVICES=1 python run.py "$method" \
    --wandb_project_name mrn_test --wandb_group first_run --exp_name test_expl_env --num_evals 50 \
    ...
    --contrastive_loss_fn bwd_infonce --energy_fn mrn \
