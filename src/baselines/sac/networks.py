    ...
    class QModule(linen.Module):
        ...
        def __call__(self, obs: jnp.ndarray, actions: jnp.ndarray):
            ...
            for _ in range(self.n_critics):
                q = MLP(layer_sizes=list(hidden_layer_sizes) + [1], activation=activation, layer_norm=layer_norm)(hidden)
                res.append(q)
...
def make_policy_network(
    ...
    policy_module = MLP(layer_sizes=list(hidden_layer_sizes) + [param_size], activation=activation, layer_norm=layer_norm)
